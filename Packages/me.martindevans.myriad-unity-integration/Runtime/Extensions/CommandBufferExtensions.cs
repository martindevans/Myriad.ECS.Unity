...
namespace Packages.me.martindevans.myriad_unity_integration.Runtime.Extensions
{
    public static class CommandBufferExtensions
    {
        ...
        {
            return SetupGameObjectBinding(entity, (Component)tr, destruct);
        }
        
        public static CommandBuffer.BufferedEntity SetupGameObjectBinding(this CommandBuffer.BufferedEntity entity, Component co, DestructMode destruct)
        {
            return SetupGameObjectBinding(entity, co.gameObject, destruct);
        }
